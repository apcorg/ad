			...
			<?php if ($rowNumber == 1 &&$node->language == $lang_name): ?> 
				 	<div data-fpi-details=<?php print $node->field_number_value; ?> class="detail-box hidden">
			 		  ...
			 		  <div class="ctas-grid text-center">
			 		    <a class="custom-button" href='/'.<?php print $lang_name ?>.'/see-principle/'.<?php print $node->nid; ?>><i class="ion-ios-list-outline bold-icon x2"></i><span>&nbsp;<?php print t('Background reading') ?></span></a>
