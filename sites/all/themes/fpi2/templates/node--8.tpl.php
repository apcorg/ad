			...
			<?php if ($rowNumber == 1 &&$node->language == $lang_name): ?> 
				 	<div data-fpi-details=<?php print $node->field_number_value; ?> class="detail-box hidden">
			 		  ...
			 		  <div class="ctas-grid text-center">
			 		    <a class="cta-button" href=/node/<?php print $node->nid; ?>><i class="ion-information-circled bold-icon x2"></i><span>&nbsp;<?php print t('Application') ?></span></a>
		...
		<?php foreach($resultPrinciples as $node) :?>
			...
			<?php if ($rowNumber == 4 && $node->language == $lang_name): ?> 
			 	<div data-fpi-details=<?php print $node->field_number_value; ?> class="detail-box hidden">
		 		  ...
		 		  <div class="ctas-grid text-center">
		 		    <a class="cta-button mt-14" href=/node/<?php print $node->nid; ?>><i class="ion-information-circled bold-icon x2"></i><span>&nbsp;<?php print t('Application') ?></span></a>
